...
export default function Authors(){
  ...
  <article class="card"><img class="avatar" src="/authors/orig/kai.png" alt="Kai Yamamoto" /><div><span class="role-pill">Breaking News</span><h3>Kai Yamamoto</h3><div class="region">Asia — Japan</div>
