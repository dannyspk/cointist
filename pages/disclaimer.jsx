...
export default function Staticdisclaimer() {
  return (
    <>
  <SEO title="Disclaimer" description="Cointist disclaimer — content is for educational purposes and not financial advice." url="/disclaimer" canonical={(process.env.SITE_URL || 'https://cointist.net') + '/disclaimer'} />
