...
export default function Staticterms() {
  return (
    <>
  <SEO title="Terms & Conditions" description="Terms & Conditions for using Cointist — legal disclaimers and service terms." url="/terms" canonical={(process.env.SITE_URL || 'https://cointist.net') + '/terms'} />
